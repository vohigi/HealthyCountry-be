...
public class ChatsGroupsService : IChatsGroupsService
{
    private readonly IChatsGroupsRepository _groupsRepository;

    public ChatsGroupsService(IChatsGroupsRepository groupsRepository)
    {
