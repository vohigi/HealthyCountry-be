...
namespace HealthyCountryTests
{
    public class UpdateUserValidatorTests
    {
        ...
        public static IEnumerable<object[]> UpdateTestData()
        {
            ...
            yield return new object[]{new UserRequestDataModel {FirstName = "aaaa", LastName = "aaaa", Gender = "MALE", Email = "vohigi@gmail.com"}, true, ""};
            ...
            yield return new object[]{new UserRequestDataModel {FirstName = "aaaa", LastName = "aaaa", Gender = "MALE", Email = "vohigi@gmail.com", Password = "Sasha280920"}, true, ""};
